...
import { TabContentSection } from "./tag-content-section";
      ...
      <div className="flex  justify-between  w-full px-4">
        ...
        <div className="w-full flex items-start  -mt-12">
          <div className="flex   items-center space-x-4">
            {company?.logo && (
              <div className="aspect-square w-auto bg-white h-32 top rounded-2xl border flex items-center justify-center relative overflow-hidden p-3">
                <Image
                  width={120}
                  height={120}
                  alt={company?.name}
            ...
            {/* name contents etc... */}
            <div className="flex-col space-y-1 mt-8">
